<template>
  <div
    ...
    <div class="flex-1 flex gap-6 flex-wrap">
      <!-- First Column -->
      <div
        class="bg-white dark:bg-dark-100 py-3 border w-full 2xl:w-[400px] border-[var(--color-border-300)] dark:border-[var(--p-content-border-color)] rounded-lg shadow-sm shadow-[rgba(0, 0, 0, 0.1)]">
        <h4
          class="font-bold border-b-1 border-gray-200 dark:border-[var(--p-content-border-color)] px-4 pb-3">
          Usage History
        </h4>
        <div
          class="flex justify-between items-center border-b-1 border-gray-200 dark:border-[var(--p-content-border-color)] pb-3">
          ...
          <div class="flex flex-col items-center py-2 px-4">
            <p>Total</p>
            <p
              class="p-1 border-1 text-center border-[var(--color-border-300)] dark:border-[var(--p-content-border-color)] rounded-2xl w-[120px]"
              size="small">
              60kW
            </p>
          </div>
        ...
        <div class="h-[490px] pt-2 overflow-y-auto">
          <div
            v-for="(value, index) in USAGE_HISTORY"
            :key="index"
            class="flex flex-1 items-center justify-between px-4 py-2">
      ...
      <div class="flex-1 flex flex-col gap-6">
        <div class="flex-1 flex flex-col gap-4">
          <div
            ...
            <div class="flex justify-between gap-2 items-center mt-2">
              <div class="flex flex-col items-center">
                ...
                <p
                  class="text-[#0084FF] pb-2 px-4 border-1 border-gray-200 rounded-[10px] dark:border-[var(--p-content-border-color)] text-[41px] font-semibold">
                  A
                </p>
              </div>
              ...
              <div class="flex flex-col">
                <p class="text-sm whitespace-nowrap">
                  Expected Daily Supply (hrs)
                </p>
                <p
                  class="px-3 border-1 border-gray-200 rounded-[10px] dark:border-[var(--p-content-border-color)]">
                  24
                </p>
              ...
              <div class="flex flex-col">
                ...
                <p
                  class="py-[19px] px-3 rounded-[10px] border-1 border-gray-200 dark:border-[var(--p-content-border-color)] text-2xl font-semibold">
                  14
                </p>
              </div>
            </div>
          ...
          <div
            ...
            <div class="flex justify-between">
              <h4 class="font-bold">
                Electricity Availability Statistics (hrs)
              </h4>
              <p
                class="text-[#0084FF] px-4 border-1 border-gray-200 rounded-[10px] dark:border-[var(--p-content-border-color)] text-[22px] font-bold">
                467
              </p>
            </div>
            <div>
              <div class="flex items-end justify-between gap-2 mt-6 h-[120px]">
                <div class="flex flex-col items-center">
                  <div
                    class="rounded-full bg-purple-300 w-10 h-[52px] flex items-center justify-center text-lg font-bold shadow">
                    52
                  </div>
                ...
                <div class="flex flex-col items-center">
                  <div
                    class="rounded-full bg-green-300 w-10 h-[70px] flex items-center justify-center text-lg font-bold shadow">
                    80
                  </div>
                ...
                <div class="flex flex-col items-center">
                  <div
                    class="rounded-full bg-blue-300 w-10 h-[80px] flex items-center justify-center text-lg font-bold shadow">
                    90
                  </div>
                ...
                <div class="flex flex-col items-center">
                  <div
                    class="rounded-full bg-red-300 w-10 h-[110px] flex items-center justify-center text-lg font-bold shadow">
                    120
                  </div>
                ...
                <div class="flex flex-col items-center">
                  <div
                    class="rounded-full bg-blue-200 w-10 h-[90px] flex items-center justify-center text-lg font-bold shadow">
                    100
                  </div>
                ...
                <div class="flex flex-col items-center">
                  <div
                    class="rounded-full bg-orange-200 w-10 h-[60px] flex items-center justify-center text-lg font-bold shadow">
                    70
                  </div>
                ...
                <div class="flex flex-col items-center">
                  <div
                    class="rounded-full bg-green-400 w-10 h-[65px] flex items-center justify-center text-lg font-bold shadow">
                    75
                  </div>
        ...
        <div
          ...
          <div
            v-for="(value, index) in NOTIFICATIONS_ALERTS"
            :key="index"
            class="mt-2">
            <div
              class="flex justify-between items-center gap-2 p-1 px-3 border-1 border-gray-200 rounded-[10px] dark:border-[var(--p-content-border-color)]">
              <div>{{ value.title }}</div>
              <div class="flex items-center justify-end w-[120px] gap-1">
                {{ value.time }}
                <v-icon
                  v-if="index < 2"
                  name="bi-circle-fill"
      ...
      <div class="flex-1 flex flex-col gap-4">
        <div
          ...
          <Chart
            ...
            :options="demandSupplyOptions(chartColor)"
            style="height: 260px" />
        </div>
        <div class="flex-1 flex flex-col gap-4">
          <div
            ...
            <div
              v-for="(value, index) in COMPLAINTS_SUPPORT"
              :key="index"
              class="mt-2">
              <div
                class="flex justify-between items-center gap-2 p-1 px-3 border-1 border-gray-200 rounded-[10px] dark:border-[var(--p-content-border-color)]">
