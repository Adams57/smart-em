<template>
  <div
    ...
    <div class="flex flex-col gap-5">
        <div class="bg-white dark:bg-dark-100 flex-1 px-3 py-5 flex flex-col gap-6 flex-wrap border border-[var(--color-border-300)] dark:border-[var(--p-content-border-color)] rounded-[10px]">
            ...
            <div
                ...
                <div
                    ...
                    <div class="flex items-center gap-2">
                        <span class="font-medium text-[16px] mt-[-5px]">{{ useMainPowerSupply ? "ON" : "OFF" }}</span>
                        <pr-toggle-switch 
                          v-model="useMainPowerSupply"/>
                    </div>
                </div>
            </div>
            <div
                ...
                <div
                    ...
                    <div class="flex items-center gap-2">
                        <span class="font-medium text-[16px] mt-[-5px]">{{ useUnitConsumption ? "ENABLED" : "DISABLED" }}</span>
                        <pr-toggle-switch 
                          v-model="useUnitConsumption"/>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="bg-white dark:bg-dark-100 flex-1 px-3 py-5 flex flex-col gap-6 flex-wrap border border-[var(--color-border-300)] dark:border-[var(--p-content-border-color)] rounded-[10px]">
            ...
            <div
              ...
              <div>
                <div class="flex items-center gap-2">
                  <v-icon name="bi-shield"
                    class="w-7 h-7" />
                  <p
                      class="font-medium text-[16px] mt-[-5px] text-[#BCBCBC] dark:text-gray-300">
                      Emergency controls should only be used in case of electrical emergencies or safety concerns.
                  </p>
                </div>
              </div>
            </div>
        ...
        <div class="bg-white dark:bg-dark-100 flex-1 px-3 py-5 flex flex-col gap-3 flex-wrap border border-[var(--color-border-300)] dark:border-[var(--p-content-border-color)] rounded-[10px]">
            ...
            <div
              ...
              <p class="font-medium text-[16px] text-[#BCBCBC] dark:text-gray-300 mb-3">Today 7:00 AM</p>
            </div>
            <div
              class="flex items-center justify-between border-b-1 border-[var(--color-border-300)] dark:border-[var(--p-content-border-color)]">
              <p class="font-medium text-[16px]">Prepaid Recharge</p>
              <p class="font-medium text-[16px] text-[#BCBCBC] dark:text-gray-300 mb-3">Yesterday, 11:00 PM</p>
            </div>
            <div
              class="flex items-center justify-between border-b-1 border-[var(--color-border-300)] dark:border-[var(--p-content-border-color)]">
              <p class="font-medium text-[16px]">Prepaid Recharge</p>
              <p class="font-medium text-[16px] text-[#BCBCBC] dark:text-gray-300 mb-3">Jan 30, 3:00 PM</p>
            </div>
        </div>
    </div>
  </div>
